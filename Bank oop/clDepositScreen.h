...
class clDepositScreen :protected clScreen
{
private:
...
public:
	static void ShowDepositScreen()
	{
		...
		double amount = InputValidate::ReadPositiveDouble("Enter the amount to deposit:");
		...
		if (ans == 'y' || ans == 'Y')
		{
			...
			cout << "\nAdded successfully, new balance is " << client.AccountBalance << endl;
			string Title = "Transaction Operation";
			string Subject = "Our dear Client, ";
			Subject += client.FirstName;
			Subject += ",\n We inform you that there a deposit opertion that have been done with your account,";
